	...
	: mFX(0)
{
	...
	*/
	...
	HRESULT hr = D3DCompileFromFile(filename.c_str(), 0, D3D_COMPILE_STANDARD_FILE_INCLUDE, "none", "fx_5_0", shaderFlags,
	...
	: Effect(device, filename)
{
	...
	ShadowMap         = mFX->GetVariableByName("gShadowMap")->AsShaderResource();
	SpecularMap		  = mFX->GetVariableByName("gSpecMap")->AsShaderResource();
	SsaoMap           = mFX->GetVariableByName("gSsaoMap")->AsShaderResource();
}
