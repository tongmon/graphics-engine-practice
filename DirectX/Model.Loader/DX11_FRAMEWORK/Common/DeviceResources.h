...
namespace DX
{
    ...
    public:
        ...
        float                   GetAspectRatio() const noexcept { return float(m_outputSize.right - m_outputSize.left) / float(m_outputSize.bottom - m_outputSize.top); }
        int                     GetClientWidth() const noexcept { return m_outputSize.right - m_outputSize.left; }
        int                     GetClientHeight() const noexcept { return m_outputSize.bottom - m_outputSize.top; }
