...
void ExtractFrustumPlanes(XMFLOAT4 planes[6], CXMMATRIX M)
{
	...
	// 왼쪽 평면
	//
	planes[0].x = tmp.m[0][3] + tmp.m[0][0];
	planes[0].y = tmp.m[1][3] + tmp.m[1][0];
	planes[0].z = tmp.m[2][3] + tmp.m[2][0];
	planes[0].w = tmp.m[3][3] + tmp.m[3][0];

	//
	// 오른쪽 평면
	//
	planes[1].x = tmp.m[0][3] - tmp.m[0][0];
	planes[1].y = tmp.m[1][3] - tmp.m[1][0];
	planes[1].z = tmp.m[2][3] - tmp.m[2][0];
	planes[1].w = tmp.m[3][3] - tmp.m[3][0];

	//
	// 아래쪽 평면
	//
	planes[2].x = tmp.m[0][3] + tmp.m[0][1];
	planes[2].y = tmp.m[1][3] + tmp.m[1][1];
	planes[2].z = tmp.m[2][3] + tmp.m[2][1];
	planes[2].w = tmp.m[3][3] + tmp.m[3][1];

	//
	// 위쪽 평면
	//
	planes[3].x = tmp.m[0][3] - tmp.m[0][1];
	planes[3].y = tmp.m[1][3] - tmp.m[1][1];
	planes[3].z = tmp.m[2][3] - tmp.m[2][1];
	planes[3].w = tmp.m[3][3] - tmp.m[3][1];

	//
	// 가까운 평면
	//
	planes[4].x = tmp.m[0][2];
	planes[4].y = tmp.m[1][2];
	planes[4].z = tmp.m[2][2];
	planes[4].w = tmp.m[3][2];

	//
	// 먼 평면
	//
	planes[2].x = tmp.m[0][3] - tmp.m[0][2];
	planes[2].y = tmp.m[1][3] - tmp.m[1][2];
	planes[2].z = tmp.m[2][3] - tmp.m[2][2];
	planes[2].w = tmp.m[3][3] - tmp.m[3][2];
