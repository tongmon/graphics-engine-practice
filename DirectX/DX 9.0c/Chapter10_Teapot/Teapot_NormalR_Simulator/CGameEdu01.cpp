...
void CGameEdu01::OnRender()
{
	...
	//D3DXMatrixRotationX(&matRotate, GetTickCount64() * 0.004f); // X축으로 시간이 지남에 따라 회전
	D3DXMatrixRotationY(&matRotate, GetTickCount64() * 0.004f);
	//D3DXMatrixRotationZ(&matRotate, GetTickCount64() * 0.004f);
