...
void CAxis::OnInit(LPDIRECT3DDEVICE9 pd3dDevice)
{
	...
	{
		{ -20.0f,  0.0f, 0.0f, D3DCOLOR_RGBA(255, 0, 0, 255) },  // x 축 (빨간색)
		{ 20.0f,  0.0f, 0.0f, D3DCOLOR_RGBA(255, 0, 0, 255) },

		{ 0.0f,  -20.0f, 0.0f, D3DCOLOR_RGBA(0, 255, 0, 255) }, // y 축 (초록색)
		{ 0.0f,  20.0f, 0.0f, D3DCOLOR_RGBA(0, 255, 0, 255) },

		{ 0.0f,  0.0f, -20.0f, D3DCOLOR_RGBA(0, 255, 255, 255) }, // z 축 (마젠타색과 유사)
		{ 0.0f,  0.0f, 20.0f, D3DCOLOR_RGBA(0, 255, 255, 255) }
	};
