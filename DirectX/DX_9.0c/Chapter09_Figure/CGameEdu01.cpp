...
void CGameEdu01::OnInit()
{
	...
	// m_pBoxMesh에 기존에 큐브 만들 때 했던 인덱스 버퍼, 정점 버퍼 등에 대한 정보다 다 들어있다.
	...
	//D3DXCreateBox(m_pd3dDevices, 2.0f, 2.0f, 2.0f, &m_pBoxMesh, NULL); // 박스
	//D3DXCreateSphere(m_pd3dDevices, 3.0f, 30, 10, &m_pSphereMesh, NULL); // 구
	//D3DXCreateTeapot( m_pd3dDevices, &m_pTeapotMesh, NULL ); // 주전자
	D3DXCreateCylinder(m_pd3dDevices, 2.0f, 2.0f, 5.0f, 30, 30, &m_pCylinderMesh, NULL); // 원기둥
}
