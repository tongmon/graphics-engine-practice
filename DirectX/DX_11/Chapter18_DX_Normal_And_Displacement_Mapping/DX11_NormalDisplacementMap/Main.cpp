...
// 먼저 도형을 만들때 정점마다 TBN-좌표계 --> 물체 국소 좌표계 이 행렬을 만들어주어야 하는데
// 이 행렬 생성에 대한 공식은 책 657p에 나와있다.
// 물체 국소 좌표계 --> 세계 좌표계 이거는 그냥 세계 변환 행렬 곱하면 되는 것이고....
...
// http://dolphin.ivyro.net/file/shader9.0/tutorial04.html 여기 설명이 잘 되어있다.
