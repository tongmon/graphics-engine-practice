// 카툰 렌더링 효과 연습
// fx 파일을 수정하면된다.
// 빛의 세기를 조절할 때 극적으로 보이기 위해
// 계단 식으로 if else 문을 사용하여 수치를 단계마다 특정 수로
// 고정을 시켜적용하면 마치 risk of rain 2와 같은 게임 그래픽이 만들어진다.
// 그리고 기본 예제들은 fxo를 읽어서 진행했는데 이게 fx 수정할 때마다
// 컴파일을 안해서 fx 파일을 읽어서 매번 컴파일 하는 방향으로
// BuildFx 함수를 수정했다.
