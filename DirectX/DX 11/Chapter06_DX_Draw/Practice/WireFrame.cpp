// BoxDemo 기반
// 와이어 프레임 연습
// 레스터화기 상태를 저장하는 변수 ID3D11RasterizerState의 포인터를 선언하고
// 레스터화기 단계에서 FillMode = D3D11_FILL_WIREFRAME 로 지정하면 된다.
// 바뀐 부분은 레스터화기 지정 단계인 Init 함수 정도.
...
bool BoxApp::Init() // 초기화
{
	...
	wireframeDesc.CullMode = D3D11_CULL_NONE; // 와이어 프레임 후면까지 다 보이기 위해 D3D11_CULL_NONE 옵션 사용
