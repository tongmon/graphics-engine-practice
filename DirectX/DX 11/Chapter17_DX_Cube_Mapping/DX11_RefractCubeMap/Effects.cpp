	...
	: Effect(device, filename)
{
	...
	Light1TexRefractTech = mFX->GetTechniqueByName("Light1TexRefract");
	Light2TexRefractTech = mFX->GetTechniqueByName("Light2TexRefract");
	Light3TexRefractTech = mFX->GetTechniqueByName("Light3TexRefract");
