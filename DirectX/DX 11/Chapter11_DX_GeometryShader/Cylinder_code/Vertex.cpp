...
// 원기둥 점점 구조
const D3D11_INPUT_ELEMENT_DESC InputLayoutDesc::CylinderV[3] =
{
	{"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"NORMAL",   0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"SIZE", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 24, D3D11_INPUT_PER_VERTEX_DATA, 0}
};
#pragma endregion
...
ID3D11InputLayout* InputLayouts::CylinderV = 0;
...
void InputLayouts::InitAll(ID3D11Device* device)
{
	...
	Effects::CylinderFX->Light3Tech->GetPassByIndex(0)->GetDesc(&passDesc);
	HR(device->CreateInputLayout(InputLayoutDesc::CylinderV, 3, passDesc.pIAInputSignature,
		passDesc.IAInputSignatureSize, &CylinderV));
}
