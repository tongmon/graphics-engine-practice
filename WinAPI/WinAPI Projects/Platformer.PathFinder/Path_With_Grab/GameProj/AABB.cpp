...
{
	if (abs(center.x - otherCenter.x) > halfSize.x + otherHalfSize.x) return false;
	if (abs(center.y - otherCenter.y) > halfSize.y + otherHalfSize.y) return false;
	return true;
}
...
{
	if (abs(a.center.x - otherCenter.x) > a.halfSize.x + otherHalfSize.x) return false;
	if (abs(a.center.y - otherCenter.y) > a.halfSize.y + otherHalfSize.y) return false;
	return true;
}
...
{
	if (abs(a.center.x - p.x) > a.halfSize.x) return false;
	if (abs(a.center.y - p.y) > a.halfSize.y) return false;
	return true;
}